...
jQuery(document).on('ready', function() {
	...
	/* -------------------------------------
			REVIEW  SLIDER
	-------------------------------------- */
	var _tg_homeslider = jQuery('#tg-review');
	_tg_homeslider.owlCarousel({
		items: 1,
		loop: true,
		dots: true,
	...
	/* -------------------------------------
			theme slider
	-------------------------------------- */
	var _tg_themeslider = jQuery('.themescar');
	_tg_themeslider.owlCarousel({
		loop: true,
		dots: false,
		nav: true,
		margin:20,
	...
	/* -------------------------------------
			destination slider
	-------------------------------------- */
	var _tg_toursdestinations = jQuery('.tg-toursdestinations');
	_tg_toursdestinations.owlCarousel({
		loop: true,
		dots: false,
		nav: true,
		margin:10,
...
$(function(){
   ...
   $('.the-links a[href*="'+page+'"]').addClass('active');
   $('.the-links a[href*="'+page+'"]').closest('li').addClass('active').siblings().removeClass('active');
   /*$('.navigation a[href*="'+page+'"]').closest('li.has-sub').addClass('active').siblings().removeClass('active');*/
   });
