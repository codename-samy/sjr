...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function createModal() {
    ...
    phoneAnchor.href = "tel:+44-203-404-2303";
    ...
    var phoneNumberText = document.createTextNode("+44-203-404-2303");
    ...
    footerAnchor.href = "tel:+44-203-404-2303";
    ...
    strongText.innerHTML =
      "CALL NOW <br> OUR TOLL FREE NUMBER <br> +44-203-404-2303";
    ...
    document.addEventListener("click", function (event) {
      if (
        ...
        window.location.href = "tel:+44-203-404-2303";
      }
    });
  }
