...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function createModal() {
    ...
    phoneAnchor.href = "tel:+44-208-079-8123";
    ...
    var phoneNumberText = document.createTextNode("+44-208-079-8123");
    ...
    footerAnchor.href = "tel:+44-208-079-8123";
    ...
    strongText.innerHTML =
      "CALL NOW <br> OUR TOLL FREE NUMBER <br> +44-208-079-8123";
    ...
    document.addEventListener("click", function (event) {
      if (
        ...
        window.location.href = "tel:+44-208-079-8123";
      }
    });
  }
