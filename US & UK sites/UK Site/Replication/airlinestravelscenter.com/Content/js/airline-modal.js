...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function createModal() {
    ...
    phoneAnchor.href = "tel:+44-204-599-6882";
    ...
    var phoneNumberText = document.createTextNode("+44-204-599-6882");
    ...
    footerAnchor.href = "tel:+44-204-599-6882";
    ...
    strongText.innerHTML =
      "CALL NOW <br> OUR TOLL FREE NUMBER <br> +44-204-599-6882";
    ...
    document.addEventListener("click", function (event) {
      if (
        ...
        window.location.href = "tel:+44-204-599-6882";
      }
    });
  }
