...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function createModal() {
    ...
    phoneAnchor.href = "tel:+44-208-079-8124";
    ...
    var phoneNumberText = document.createTextNode("+44-208-079-8124");
    ...
    footerAnchor.href = "tel:+44-208-079-8124";
    ...
    strongText.innerHTML =
      "CALL NOW <br> OUR TOLL FREE NUMBER <br> +44-208-079-8124";
    ...
    document.addEventListener("click", function (event) {
      if (
        ...
        window.location.href = "tel:+44-208-079-8124";
      }
    });
  }
