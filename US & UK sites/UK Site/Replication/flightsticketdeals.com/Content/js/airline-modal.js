...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function createModal() {
    ...
    phoneAnchor.href = "tel:+44-208-079-8130";
    ...
    var phoneNumberText = document.createTextNode("+44-208-079-8130");
    ...
    footerAnchor.href = "tel:+44-208-079-8130";
    ...
    strongText.innerHTML =
      "CALL NOW <br> OUR TOLL FREE NUMBER <br> +44-208-079-8130";
    ...
    document.addEventListener("click", function (event) {
      if (
        ...
        window.location.href = "tel:+44-208-079-8130";
      }
    });
  }
