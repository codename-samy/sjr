...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function createModal() {
    ...
    phoneAnchor.href = "tel:+44-800-524-4288";
    ...
    var phoneNumberText = document.createTextNode("+44-800-524-4288");
    ...
    footerAnchor.href = "tel:+44-800-524-4288";
    ...
    strongText.innerHTML =
      "CALL NOW <br> OUR TOLL FREE NUMBER <br> +44-800-524-4288";
    ...
    document.addEventListener("click", function (event) {
      if (
        ...
        window.location.href = "tel:+44-800-524-4288";
      }
    });
  }
