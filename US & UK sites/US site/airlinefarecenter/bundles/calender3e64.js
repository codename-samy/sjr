...
function ShowHideSearchEngineTab(n) {
  ...
  switch (n) {
    case "RT":
      ...
      $(".iexchangeIcon").attr(
        "src",
        "/Content/images/roundtrip-flightIcon.png"
      );
...
function GetCabinTypeForDesktop(n, t, i) {
  var r = parseInt($("#txtAdultPassenger").val()),
    u = parseInt($("#txtChildPassenger").val()),
    f = parseInt($("#txtInfantSeatPassenger").val()),
    e = parseInt($("#txtInfantPassenger").val()),
    o = r + u + e + f;
  $("#LstCabinClass").val(n);
...
function checkMulticityGetRT() {
  ...
  return (
    $("#hdnMC_Sec_2").val() != "1" &&
      $("#hdnOriginCode_0").val() == $("#hdnDestinationCode_1").val() &&
      $("#hdnOriginCode_1").val() == $("#hdnDestinationCode_0").val() &&
      (n = "1"),
    n
  );
}
function UpdatePassengerCount(n, t) {
  var f = 0,
    ...
    h = 0,
    c = 0,
    u = $("#txtAdultPassenger").val(),
    v = $("#txtChildPassenger").val(),
    i = $("#txtInfantSeatPassenger").val(),
    r = $("#txtInfantPassenger").val(),
    l,
    a;
  switch (t) {
    case "ADT":
      f = u;
      n == 1
        ? parseInt(i) + parseInt(v) + parseInt(u) < 9 &&
          $("#txtAdultPassenger").val(parseInt(u) + 1)
        : f > e + 1 &&
          ($("#txtAdultPassenger").val(parseInt(u) - 1),
          (parseInt(i) == parseInt(u) ||
            parseInt(r) == parseInt(u) ||
            parseInt(r) + parseInt(i) <= parseInt(u) * 2) &&
            (parseInt($("#txtInfantPassenger").val()) > 0 &&
            parseInt(i) < 1 &&
            parseInt(r) == parseInt(u)
              ? $("#txtInfantPassenger").val(parseInt(r) - 1)
              : parseInt($("#txtInfantPassenger").val()) > 0 &&
                parseInt(i) > 0 &&
                (parseInt(r) + parseInt(i) >
                  parseInt($("#txtAdultPassenger").val()) * 2 ||
                  parseInt(r) == parseInt(u)) &&
                $("#txtInfantPassenger").val(parseInt(r) - 1),
            parseInt($("#txtInfantSeatPassenger").val()) > 0 &&
            parseInt(r) < 1 &&
            parseInt($("#txtInfantSeatPassenger").val()) >
              parseInt($("#txtAdultPassenger").val()) * 2
              ? parseInt($("#txtInfantSeatPassenger").val()) > 1
                ? $("#txtInfantSeatPassenger").val(parseInt(i) - 2)
                : $("#txtInfantSeatPassenger").val(parseInt(i) - 1)
              : parseInt($("#txtInfantSeatPassenger").val()) > 0 &&
                parseInt(r) > 0 &&
                parseInt(r) + parseInt(i) >
                  parseInt($("#txtAdultPassenger").val()) * 2 &&
    ...
    case "CHD":
      ...
      n == 1
        ? parseInt(i) +
            parseInt($("#txtChildPassenger").val()) +
            parseInt($("#txtAdultPassenger").val()) <
            9 &&
          $("#txtChildPassenger").val(
            parseInt($("#txtChildPassenger").val()) + 1
          )
        : f > e &&
          parseInt($("#txtChildPassenger").val()) > 0 &&
          $("#txtChildPassenger").val(
            parseInt($("#txtChildPassenger").val()) - 1
          );
      break;
    case "INFL":
      parseInt($("#txtInfantPassenger").val()) <=
        parseInt($("#txtAdultPassenger").val()) &&
        (f = parseInt($("#txtInfantPassenger").val()));
      n == 1
        ? ValidateAdultIosIol() &&
          $("#txtInfantPassenger").val(
            parseInt($("#txtInfantPassenger").val()) + 1
          )
        : f > e &&
          parseInt($("#txtInfantPassenger").val()) > 0 &&
          $("#txtInfantPassenger").val(
...
function DisableReturnField() {
  var t, i, n;
  if (
    ($("#divReturnSection").prop("style") != null &&
      $("#divReturnSection").prop("style") != undefined &&
      ($(".lightpick").remove(),
      (t = $("#txtDepartDate").val()),
      (i = $("#txtReturnDate").val()),
      (t = t == "" ? "01/01/2019" : t),
          ...
          (n = new Lightpick({
            ...
            onSelect: function (t) {
              if (
                ...
                if (n._opts.TargetDPId == "txtDepartDate")
                  if (
                    ((n._opts.minDate = moment(
                      document.getElementById("txtDepartDate").value
                    )),
                    document.getElementById("txtReturnDate").value == null ||
                    ...
                    var i = document
                        .getElementById("txtReturnDate")
                        .value.split("/"),
                      r = i[0],
                      u = i[1],
                      f = i[2],
                      e = new Date(parseInt(f), parseInt(r) - 1, parseInt(u));
                    t > e
                      ? ((n._opts.startDate = moment(
                          document.getElementById("txtDepartDate").value
                        )),
                        (n._opts.endDate = null),
                        this.hide(),
                        (document.getElementById("txtReturnDate").value = ""),
                        setTimeout(function () {
                          document.getElementById("txtReturnDate").click();
          ...
          (n = new Lightpick({
            ...
            onSelect: function (t) {
              if (
                ...
                (document.getElementById("txtReturnDate").value = ""),
                  this.hide();
              else if (n._opts.TargetDPId == "txtDepartDate")
                if (
                  ((n._opts.minDate = moment(
                    document.getElementById("txtDepartDate").value
                  )),
    ...
    $("#divDepartSecton_0").prop("style") != null &&
      $("#divDepartSecton_0").prop("style") != undefined &&
      $("#hdnTripTypeCode").val() === "3")
  ) {
    var t = $("#txtDepartDate_0").val(),
      r = $("#txtDepartDate_1").val(),
      i = $("#txtDepartDate_2").val();
    t = t == "" ? "01/01/2019" : t;
    r = r == "" ? "01/01/2019" : r;
    i = i == "" ? "01/01/2019" : i;
    n = new Lightpick({
      ...
      onSelect: function (t, i) {
        if (
          ...
          if (
            ((n._opts.minDate = moment(
              document.getElementById("txtDepartDate_0").value
            )),
            (document.getElementById("txtDepartDate_1").value != null &&
              document.getElementById("txtDepartDate_1").value != "") ||
              (document.getElementById("txtDepartDate_2").value != null &&
            ...
            if (
              ...
              var s = document
                  .getElementById("txtDepartDate_1")
                  .value.split("/"),
                r = document.getElementById("txtDepartDate_2").value.split("/"),
                u = r[0],
                f = r[1],
                e = r[2],
                o = new Date(parseInt(e), parseInt(u) - 1, parseInt(f)),
                c = s[0],
                l = s[1],
                a = s[2],
                h = new Date(parseInt(a), parseInt(c) - 1, parseInt(l));
              t > o && t > h
                ? ((n._opts.startDate = moment(
                    document.getElementById("txtDepartDate_0").value
                  )),
                  (n._opts.midDate = null),
                  (n._opts.endDate = null),
                  (document.getElementById("txtDepartDate_1").value = ""),
                  (document.getElementById("txtDepartDate_2").value = ""))
                : t > h &&
            ...
            if (
              ...
              var r = document
                  .getElementById("txtDepartDate_2")
                  .value.split("/"),
                u = r[0],
                f = r[1],
                e = r[2],
          ...
          if (
            ...
            var r = document.getElementById("txtDepartDate_2").value.split("/"),
              u = r[0],
              f = r[1],
              e = r[2],
              o = new Date(parseInt(e), parseInt(u) - 1, parseInt(f));
            i > o &&
              ((n._opts.midDate = moment(
                document.getElementById("txtDepartDate_1").value
              )),
              (n._opts.endDate = null),
              (document.getElementById("txtDepartDate_2").value = ""));
...
function GetHotelWidgetAndDeals() {
  return (
    ($("#formHotelSearch") == null ||
      $("#formHotelSearch") == undefined ||
      $("#formHotelSearch").length == 0) &&
      function (n) {
...
(function (n, t) {
  ...
  function bh(n) {
    var t = [],
      i;
    for (i in n) t.push({ unit: i, priority: cu[i] });
    return (
      t.sort(function (n, t) {
  ...
  function aa(n, t, i) {
    ...
    return i == null
      ...
      ? n.meridiemHour(t, i)
      : n.isPM != null
      ? ((r = n.isPM(i)), r && t < 12 && (t += 12), r || t !== 12 || (t = 0), t)
      : t;
  }
  function va(n) {
    var t, e, f, r, i;
      ...
      ? ((n = {}),
        ...
        n._a
          ? ((t = n._isUTC ? et(n._a) : c(n._a)),
            (this._isDSTShifted = this.isValid() && gf(n._a, t.toArray()) > 0))
  ...
  (function (n, t) {
    ...
    var t = window.document,
      o = {
        ...
        locale: {
          ...
          pluralize: function (n, t) {
            return (typeof n == "string" && (n = parseInt(n, 10)),
            n === 1 && "one" in t)
              ? t.one
              : "other" in t
              ? t.other
      ...
      f = function (n) {
        var r = new Date(
            n.calendar[0]._d.getFullYear(),
            n.calendar[0]._d.getMonth() - 1,
            28
          ),
          i;
        n.calendar[1] != null &&
          (i = new Date(
            n.calendar[1]._d.getFullYear(),
            n.calendar[1]._d.getMonth(),
            1
          ));
        var u = new Date(
            n.minDate._d.getFullYear(),
            n.minDate._d.getMonth(),
            1
          ),
          f = new Date(n.maxDate._d.getFullYear(), n.maxDate._d.getMonth(), 1),
          t = '<div class="lightpick__toolbar">';
        return (
          (t +=
            '<div class="lightpick_selecteddate_header"><span class="lightpick_selecteddate_From_Date"></span><span class="lightpick_selecteddate_Separator">=></span><span class="lightpick_selecteddate_To_Date"></span></div>'),
          (t += ""),
          (t +=
            r >= u
              ? '<button type="button" class="lightpick__previous-action">' +
                n.locale.buttons.prev +
                "</button>"
              : '<button type="button" class="lightpick__previous-action" style="visibility :hidden" >' +
                n.locale.buttons.prev +
                "</button>"),
          (t +=
            n.calendar[1] == null
              ? '<button type="button" class="lightpick__next-action">' +
                n.locale.buttons.next +
                "</button>"
              : i <= f
              ? '<button type="button" class="lightpick__next-action">' +
                n.locale.buttons.next +
                "</button>"
              : '<button type="button" class="lightpick__next-action"  style="visibility :hidden" >' +
                n.locale.buttons.next +
                "</button>"),
          t +
            ((!n.autoclose && !n.inline
              ? '<button type="button" class="lightpick__close-action">' +
                n.locale.buttons.close +
                "</button>"
              : "") +
              "</div>")
        );
      ...
      u = function (i, r, u, f) {
        ...
        if (i.multiDate) {
          if (
            ...
            Object.prototype.toString.call(f) === "[object Array]"
              ? ((f = f.filter(function (n) {
                ...
                (e.className = e.className.concat(f)))
              : e.className.push(f),
            i.disableDates)
          )
            for (o = 0; o < i.disableDates.length; o++)
              i.disableDates[o] instanceof Array ||
              Object.prototype.toString.call(i.disableDates[o]) ===
                "[object Array]"
                ? ((c = n(i.disableDates[o][0])),
                  (l = n(i.disableDates[o][1])),
                  c.isValid() &&
                    l.isValid() &&
                    r.isBetween(c, l, "day", "[]") &&
                    e.className.push("is-disabled"))
                : n(i.disableDates[o]).isValid() &&
                  n(i.disableDates[o]).isSame(r, "day") &&
                  e.className.push("is-disabled"),
                e.className.indexOf("is-disabled") >= 0 &&
                  (i.locale.tooltipOnDisabled &&
                    (!i.startDate ||
                      r.isAfter(i.startDate) ||
                      (i.startDate && i.endDate)) &&
                    e.className.push("disabled-tooltip"),
                  e.className.indexOf("is-start-date") >= 0
                    ? (this.setStartDate(null),
                      this.setMidDate(null),
                      this.setEndDate(null))
                    : e.className.indexOf("is-mid-date") >= 0
                    ? (this.setMidDate(null), this.setEndDate(null))
                    : e.className.indexOf("is-end-date") >= 0 &&
                      this.setEndDate(null));
          i.minDays &&
            i.startDate &&
            !i.midDate &&
            !i.endDate &&
            r.isBetween(
              n(i.startDate).subtract(i.minDays - 1, "day"),
              n(i.startDate).add(i.minDays - 1, "day"),
              "day"
            ) &&
            (e.className.push("is-disabled"),
            i.selectForward &&
              r.isSameOrAfter(i.startDate) &&
              (e.className.push("is-forward-selected"),
              e.className.push("is-in-range")));
          i.maxDays &&
            i.startDate &&
            !i.midDate &&
            !i.endDate &&
            (r.isSameOrBefore(n(i.startDate).subtract(i.maxDays, "day"), "day")
              ? e.className.push("is-disabled")
              : r.isSameOrAfter(n(i.startDate).add(i.maxDays, "day"), "day") &&
                e.className.push("is-disabled"));
          i.repick && (i.minDays || i.maxDays) && i.startDate && i.endDate
            ? ((s = n(i.repickTrigger == i.field ? i.endDate : i.startDate)),
              i.minDays &&
                r.isBetween(
                  n(s).subtract(i.minDays - 1, "day"),
                  n(s).add(i.minDays - 1, "day"),
                  "day"
                ) &&
                e.className.push("is-disabled"),
              i.maxDays &&
                (r.isSameOrBefore(n(s).subtract(i.maxDays, "day"), "day")
                  ? e.className.push("is-disabled")
                  : r.isSameOrAfter(n(s).add(i.maxDays, "day"), "day") &&
                    e.className.push("is-disabled")))
            : i.repick &&
              (i.minDays || i.maxDays) &&
              i.startDate &&
              i.midDate &&
              !i.endDate &&
              ((s = n(i.repickTrigger == i.field ? i.midDate : i.startDate)),
              i.minDays &&
                r.isBetween(
                  n(s).subtract(i.minDays - 1, "day"),
                  n(s).add(i.minDays - 1, "day"),
          ...
          i.startDate &&
          i.endDate &&
          r.isBetween(i.startDate, i.endDate, "day", "[]")
            ? e.className.push("is-in-range")
            : i.startDate &&
              i.midDate &&
              !i.endDate &&
              r.isBetween(i.startDate, i.midDate, "day", "[]") &&
              e.className.push("is-in-range");
          n().isSame(r, "month") ||
            (a.isSame(r, "month")
              ? e.className.push("is-previous-month")
              : v.isSame(r, "month") && e.className.push("is-next-month"));
          i.minDate &&
            r.isBefore(i.minDate, "day") &&
            e.className.push("is-disabled");
          i.maxDate &&
            r.isAfter(i.maxDate, "day") &&
            e.className.push("is-disabled");
          i.selectForward &&
          !i.singleDate &&
          i.startDate &&
          ...
          r.isAfter(i.startDate, "day")
            ...
            : i.selectBackward &&
              ...
              e.className.push("is-disabled");
          i.disableWeekends &&
            (r.isoWeekday() == 6 || r.isoWeekday() == 7) &&
            e.className.push("is-disabled");
          e.className = e.className.filter(function (n, t, i) {
            return i.indexOf(n) === t;
          });
          e.className.indexOf("is-disabled") >= 0 &&
            e.className.indexOf("is-available") >= 0 &&
            e.className.splice(e.className.indexOf("is-available"), 1);
      ...
      c = function (i, r) {
        for (var o = n(i), u = t.createElement("select"), e, f = 0; f < 12; f++)
          o.set("month", f),
            (e = t.createElement("option")),
            (e.value = o.toDate().getMonth()),
            (e.text = getMomentMonthName(o.toDate().getMonth())),
            f === i.toDate().getMonth() &&
              e.setAttribute("selected", "selected"),
            u.appendChild(e);
        return (
          (u.className = "lightpick__select lightpick__select-months"),
          (u.dir = "rtl"),
          (r.dropdowns && r.dropdowns.months) || (u.disabled = !0),
          u.outerHTML
        );
      },
      l = function (i, r) {
        var s = n(i),
          o = t.createElement("select"),
          u = r.dropdowns && r.dropdowns.years ? r.dropdowns.years : null,
          h = u && u.min ? u.min : 1900,
          c = u && u.max ? u.max : parseInt(n().format("YYYY")),
          f,
          e;
        for (
          parseInt(i.format("YYYY")) < h && (h = parseInt(i.format("YYYY"))),
            parseInt(i.format("YYYY")) > c && (c = parseInt(i.format("YYYY"))),
            f = h;
          f <= c;
          f++
        )
          s.set("year", f),
            (e = t.createElement("option")),
            (e.value = s.toDate().getFullYear()),
            (e.text = s.toDate().getFullYear()),
            f === i.toDate().getFullYear() &&
              e.setAttribute("selected", "selected"),
            o.appendChild(e);
        return (
          (o.className = "lightpick__select lightpick__select-years"),
          (r.dropdowns && r.dropdowns.years) || (o.disabled = !0),
          o.outerHTML
        );
      },
      r = function (t, i) {
        for (
          var r = "", k = n(i.calendar[0]), e, a, w, nt, v, d, o, b, y, h = 0;
          h < i.numberOfMonths;
          h++
        ) {
          for (
          ...
          if (
            ((r += "</div>"),
            (r += '<div class="lightpick__days">'),
            e.isoWeekday() !== i.firstDay)
          ) {
            var g =
                e.isoWeekday() - i.firstDay > 0
                  ? e.isoWeekday() - i.firstDay
                  : e.isoWeekday(),
              p = n(e).subtract(g, "day"),
              w = p.daysInMonth();
            for (o = p.get("date"); o <= w; o++)
              (r += u(i, p, h > 0, "is-previous-month")), p.add(1, "day");
          }
          for (w = e.daysInMonth(), nt = new Date(), o = 0; o < w; o++)
            (r += u(i, e)), e.add(1, "day");
          if (((v = n(e)), (d = 7 - v.isoWeekday() + i.firstDay), d < 7))
            for (o = v.get("date"); o <= d; o++)
              (r += u(i, v, h < i.numberOfMonths - 1, "is-next-month")),
                v.add(1, "day");
          r += "</div>";
          r += "</section>";
          k.add(1, "month");
        ...
        i.multiDate
          ? ($(".lightpick_selecteddate_Separator").hide(),
            ...
            $(".lightpick_selecteddate_From_Date").addClass(
              "selecteddate_highlighter"
            ),
            i.TargetDPId == "txtDepartDate_0" &&
              (i.startDate != null
                ? $(".lightpick_selecteddate_From_Date").html(
                    n(i.startDate).format("ddd DD MMM, YY")
                  )
                : $(".lightpick_selecteddate_From_Date").html(
                    n().format("ddd DD MMM, YY")
                  )),
            i.TargetDPId == "txtDepartDate_1" &&
              (i.midDate != null
                ? $(".lightpick_selecteddate_From_Date").html(
                    n(i.midDate).format("ddd DD MMM, YY")
                  )
                : i.startDate != null
                ? $(".lightpick_selecteddate_From_Date").html(
                    n(i.startDate).format("ddd DD MMM, YY")
            ...
            i.TargetDPId == "txtDepartDate_2" &&
              (i.endDate != null
                ? $(".lightpick_selecteddate_From_Date").html(
                    n(i.endDate).format("ddd DD MMM, YY")
                  )
                : i.midDate != null
                ? $(".lightpick_selecteddate_From_Date").html(
                    n(i.midDate).format("ddd DD MMM, YY")
          ...
          : ($(".lightpick_selecteddate_Separator").show(),
            ...
            (b =
              '<span class="lightpick_selecteddate_From_Date_Header">Depart</span>'),
            (y =
              '<span class="lightpick_selecteddate_To_Date_Header">Return</span>'),
            (i.TargetDPId == "tbCheckIn" || i.TargetDPId == "tbCheckOut") &&
              ((b =
                '<span class="lightpick_selecteddate_From_Date_Header">Check-in</span>'),
              (y =
                '<span class="lightpick_selecteddate_To_Date_Header">Check-out</span>')),
            i.TargetDPId == "txtDepartDate" || i.TargetDPId == "tbCheckIn"
              ? ($(".lightpick_selecteddate_From_Date").addClass(
                  "selecteddate_highlighter"
                ),
                $(".lightpick_selecteddate_To_Date").removeClass(
                  "selecteddate_highlighter"
                ))
              : ($(".lightpick_selecteddate_From_Date").removeClass(
                  "selecteddate_highlighter"
                ),
                $(".lightpick_selecteddate_To_Date").addClass(
                  "selecteddate_highlighter"
                )),
            i.startDate != null
              ? $(".lightpick_selecteddate_From_Date").html(
                  b + n(i.startDate).format("ddd DD MMM, YY")
                )
              : $(".lightpick_selecteddate_From_Date").html(
                  b + n().format("ddd DD MMM, YY")
                ),
            i.singleDate == !1 && i.endDate != null
              ? $(".lightpick_selecteddate_To_Date").html(
                  y + n(i.endDate).format("ddd DD MMM, YY")
                )
              : i.singleDate == !1 && i.endDate == null
              ? i.startDate != null
                ? $(".lightpick_selecteddate_To_Date").html(
                    y + n(i.startDate).format("ddd DD MMM, YY")
                  )
                : $(".lightpick_selecteddate_To_Date").html(
                    y + n().format("ddd DD MMM, YY")
                  )
              : ($(".lightpick_selecteddate_To_Date").html(""),
                $(".lightpick_selecteddate_To_Date").hide(),
                $(".lightpick_selecteddate_Separator").hide()));
      ...
      i = function (n, t) {
        ...
        [].forEach.call(i, function (n) {
          n.outerHTML = u(
            t,
            parseInt(n.getAttribute("data-time")),
            !1,
            n.className.split(" ")
          );
        });
      ...
      e = function (t, i) {
        if (i.multiDate) {
          ...
          var e = t.querySelectorAll(".lightpick__day"),
            f = i.disableDates.map(function (n) {
          ...
          [].forEach.call(e, function (t) {
            ...
            ((r && f.isBefore(r) && i.startDate.isAfter(r)) ||
              (u && f.isAfter(u) && u.isAfter(i.startDate))) &&
      ...
      h = function (r) {
        ...
        u.el.className =
          "lightpick lightpick--" + e.numberOfColumns + "-columns is-hidden";
        e.inline && (u.el.className += " lightpick--inlined");
        o =
          '<div class="lightpick__inner">' +
          (e.numberOfMonths > 1 ? f(e, "days") : "") +
        ...
        e.footer &&
          ...
          e.footer === !0
            ? ((o +=
                ...
                e.locale.buttons.reset +
                "</button>"),
              (o += '<div class="lightpick__footer-message"></div>'),
              (o +=
                '<button type="button" class="lightpick__apply-action">' +
                e.locale.buttons.apply +
                "</button>"))
            : (o += e.footer),
          (o += "</div>"));
        o += "</div>";
        u.el.innerHTML = o;
        e.parentEl instanceof Node
          ? e.parentEl.appendChild(u.el)
          : e.parentEl === "body" && e.inline
          ? e.field.parentNode.appendChild(u.el)
          : t.querySelector(e.parentEl).appendChild(u.el);
        u._onMouseDown = function (t) {
          var f, r, e, o;
          if (
            u.isShowing &&
            ((t = t || window.event), (f = t.target || t.srcElement), f)
          )
            if (
              (t.stopPropagation(),
              f.classList.contains("lightpick__select") || t.preventDefault(),
              (r = u._opts),
              r.multiDate)
            )
              if (
                f.classList.contains("lightpick__day") &&
                f.classList.contains("is-available")
              ) {
                if (
                  ((e = n(parseInt(f.getAttribute("data-time")))),
                  !r.disabledDatesInRange &&
                    r.disableDates &&
                    r.startDate &&
                    !r.midDate)
                ) {
                  var s = e.isAfter(r.startDate) ? n(r.startDate) : n(e),
                    h = e.isAfter(r.startDate) ? n(e) : n(r.startDate),
                    c = r.disableDates.filter(function (t) {
                      if (
                        t instanceof Array ||
                  ...
                  if (c.length) {
                    ...
                    u.el.querySelector(".lightpick__tooltip").style.visibility =
                      "hidden";
                    i(u.el, r);
                    return;
                  }
                }
                (!r.startDate && !r.midDate && !r.endDate) ||
                (r.startDate && r.midDate && r.endDate)
                  ? r.repick && r.startDate && r.midDate && r.endDate
                    ? (r.repickTrigger === r.field
                        ? (u.setStartDate(e), f.classList.add("is-start-date"))
                        : r.repickTrigger === r.midField
                        ? (u.setMidDate(e), f.classList.add("is-mid-date"))
                    ...
                    : r.repick && !r.startDate && r.midDate && r.endDate
                    ? (r.TargetDPId == "txtDepartDate_0" &&
                        (u.setStartDate(e), f.classList.add("is-start-date")),
                      r.singleDate && r.autoclose
                        ? setTimeout(function () {
                            u.hide();
                          }, 100)
                        : (!r.singleDate || r.inline) && i(u.el, r))
                    : r.repick && r.startDate && !r.midDate && r.endDate
                    ? (r.TargetDPId == "txtDepartDate_1" &&
                        (u.setMidDate(e), f.classList.add("is-mid-date")),
                      r.singleDate && r.autoclose
                        ? setTimeout(function () {
                            u.hide();
                    ...
                    : (r.TargetDPId == "txtDepartDate_0"
                        ? (u.setStartDate(e),
                          u.setMidDate(null),
                          u.setEndDate(null),
                          f.classList.add("is-start-date"))
                        : r.TargetDPId == "txtDepartDate_1"
                        ? (u.setStartDate(null),
                          u.setMidDate(e),
                          u.setEndDate(null),
                          f.classList.add("is-mid-date"))
                        : r.TargetDPId == "txtDepartDate_2" &&
                          (u.setStartDate(null),
                          u.setMidDate(null),
                          u.setEndDate(e),
                          f.classList.add("is-end-date")),
                      r.autoclose
                        ? setTimeout(function () {
                            u.hide();
                          }, 100)
                        : (!r.singleDate || r.inline) &&
                          (i(u.el, r),
                          setTimeout(function () {
                            u.hide();
                          }, 100)))
                  ...
                  : (r.TargetDPId == "txtDepartDate_0" &&
                    ...
                    r.TargetDPId == "txtDepartDate_1"
                      ...
                      : r.TargetDPId == "txtDepartDate_2" &&
                        ...
                        f.classList.add("is-end-date")));
                r.disabledDatesInRange ||
                  (u.el.querySelectorAll(".lightpick__day.is-available")
                    .length === 0 &&
                    (u.setStartDate(null),
                    i(u.el, r),
                    r.footer &&
                      (typeof u._opts.onError == "function"
                        ? u._opts.onError.call(u, "Invalid range")
                        : ((o = u.el.querySelector(
                            ".lightpick__footer-message"
                          )),
                          o &&
                            ((o.innerHTML = r.locale.not_allowed_range),
                            setTimeout(function () {
                              o.innerHTML = "";
                            }, 3e3))))));
              } else
                f.classList.contains("lightpick__previous-action")
                  ? u.prevMonth()
                  : f.classList.contains("lightpick__next-action")
                  ? u.nextMonth()
                  : f.classList.contains("lightpick__close-action") ||
                    f.classList.contains("lightpick__apply-action")
                  ? u.hide()
                  : f.classList.contains("lightpick__reset-action") &&
                    u.reset();
            else if (
              f.classList.contains("lightpick__day") &&
              f.classList.contains("is-available")
              ...
              if (
                ((e = n(parseInt(f.getAttribute("data-time")))),
                !r.disabledDatesInRange && r.disableDates && r.startDate)
              ) {
                var s = e.isAfter(r.startDate) ? n(r.startDate) : n(e),
                  h = e.isAfter(r.startDate) ? n(e) : n(r.startDate),
                  c = r.disableDates.filter(function (t) {
              ...
              (r.startDate && r.endDate)
                ? r.repick && r.startDate && r.endDate
                  ? (r.repickTrigger === r.field
                      ? (u.setStartDate(e), f.classList.add("is-start-date"))
                      : (u.setEndDate(e), f.classList.add("is-end-date")),
                    r.startDate.isAfter(r.endDate),
                    r.autoclose &&
                      setTimeout(function () {
                        u.hide();
                      }, 100))
                  : r.repick && !r.startDate && r.endDate
                  ? (r.TargetDPId == "txtDepartDate" &&
                      (u.setStartDate(e), f.classList.add("is-start-date")),
                    r.TargetDPId == "tbCheckIn" &&
                      (u.setStartDate(e), f.classList.add("is-start-date")),
                    r.singleDate && r.autoclose
                      ? setTimeout(function () {
                          u.hide();
              ...
              r.disabledDatesInRange ||
                (u.el.querySelectorAll(".lightpick__day.is-available")
                  ...
                  r.footer &&
                    (typeof u._opts.onError == "function"
                      ? u._opts.onError.call(u, "Invalid range")
                      : ((o = u.el.querySelector(".lightpick__footer-message")),
                        o &&
                          ((o.innerHTML = r.locale.not_allowed_range),
                          setTimeout(function () {
                            o.innerHTML = "";
              ...
              f.classList.contains("lightpick__previous-action")
                ...
                : f.classList.contains("lightpick__close-action") ||
                  f.classList.contains("lightpick__apply-action")
                ? u.hide()
                : f.classList.contains("lightpick__reset-action") && u.reset();
        };
        u._onMouseEnter = function (t) {
          var r, i, f, o, e, h, s;
          if (
            u.isShowing &&
            ((t = t || window.event), (r = t.target || t.srcElement), r) &&
            ((i = u._opts), !i.multiDate)
          ) {
            if (
              r.classList.contains("lightpick__day") &&
              r.classList.contains("disabled-tooltip") &&
              i.locale.tooltipOnDisabled
            ) {
              u.showTooltip(r, i.locale.tooltipOnDisabled);
              return;
            }
            if ((u.hideTooltip(), i.singleDate || (!i.startDate && !i.endDate)))
              return;
            if (
              !r.classList.contains("lightpick__day") &&
              !r.classList.contains("is-available")
            )
              return;
            if ((i.startDate && !i.endDate) || i.repick) {
              if (
                ((f = n(parseInt(r.getAttribute("data-time")))), !f.isValid())
              )
                return;
              o =
                (i.startDate && !i.endDate) ||
              ...
              [].forEach.call(e, function (t) {
                ...
                r.isValid() &&
                r.isSameOrAfter(o, "day") &&
                r.isSameOrBefore(f, "day")
                  ? (t.classList.add("is-in-range"),
                    i.repickTrigger === i.field && r.isSameOrAfter(i.endDate)
                      ? t.classList.remove("is-in-range")
                      : i.repickTrigger !== i.field ||
                        i.endDate ||
                        t.classList.remove("is-in-range"))
                  : r.isValid() &&
                    r.isSameOrAfter(f, "day") &&
                    r.isSameOrBefore(o, "day")
                  ? (t.classList.add("is-in-range"),
                    ((i.startDate && !i.endDate) ||
                      i.repickTrigger === i.secondField) &&
                      r.isSameOrBefore(i.startDate) &&
                      t.classList.remove("is-in-range"))
                  : t.classList.remove("is-in-range");
                i.startDate &&
                i.endDate &&
              ...
              i.hoveringTooltip &&
                ((e = Math.abs(
                  f.isAfter(o) ? f.diff(o, "day") : o.diff(f, "day")
                )),
                i.tooltipNights || (e += 1),
                (h = u.el.querySelector(".lightpick__tooltip")),
                e > 0 && !r.classList.contains("is-disabled")
                  ? ((s = ""),
                    typeof i.locale.pluralize == "function" &&
                      (s = i.locale.pluralize.call(u, e, i.locale.tooltip)),
                    u.showTooltip(r, e + " " + s))
                  : u.hideTooltip());
              i.startDate &&
              i.endDate &&
              i.repick &&
              i.repickTrigger === i.field
                ? r.classList.add("is-start-date")
                : !i.startDate &&
                  i.endDate &&
                  i.repick &&
                  i.repickTrigger === i.field
                ? r.classList.add("is-start-date")
                : r.classList.add("is-end-date");
            }
          }
        };
        ...
        u._onInputChange = function (n) {
          var t = n.target || n.srcElement;
          u._opts.singleDate &&
            (u._opts.autoclose || u.gotoDate(e.field.value));
          u.syncFields();
          u.isShowing || u.show();
        };
        u._onInputFocus = function (i) {
          ...
          u._opts.multiDate
            ? (u.hide(),
              r.id == "txtDepartDate_0"
                ? (u._opts.minDate = n())
                : r.id == "txtDepartDate_1"
                ? (u._opts.minDate =
                    t.getElementById("txtDepartDate_0").value != null &&
                    t.getElementById("txtDepartDate_0").value != ""
                      ? n(t.getElementById("txtDepartDate_0").value)
                      : n())
                : r.id == "txtDepartDate_2" &&
                  (u._opts.minDate =
                    t.getElementById("txtDepartDate_1").value != null &&
                    t.getElementById("txtDepartDate_1").value != ""
                      ? n(t.getElementById("txtDepartDate_1").value)
                      : t.getElementById("txtDepartDate_0").value != null &&
                        t.getElementById("txtDepartDate_0").value != ""
                      ? n(t.getElementById("txtDepartDate_0").value)
                      : n()))
            : (u.hide(),
              r.id == "txtDepartDate"
                ...
                : r.id == "txtReturnDate" &&
                  (u._opts.minDate =
                    t.getElementById("txtDepartDate").value != null &&
                    t.getElementById("txtDepartDate").value != ""
                      ? n(t.getElementById("txtDepartDate").value)
                      : n()),
              r.id == "tbCheckIn"
                ? (u._opts.minDate = n())
                : r.id == "tbCheckOut" &&
                  (u._opts.minDate =
                    t.getElementById("tbCheckIn").value != null &&
                    t.getElementById("tbCheckIn").value != ""
                      ? n(t.getElementById("tbCheckIn").value).add(1, "day")
                      : n()));
          u._onInputClick(i);
        };
            ...
            if (e.multiDate) {
              do
                if (
                  ...
                  t === e.field ||
                  (e.midField && t === e.midField) ||
                  (e.secondField && t === e.secondField)
                )
                  return;
        ...
        u.showTooltip = function (n, t) {
          var i = u.el.querySelector(".lightpick__tooltip"),
            h = u.el.classList.contains("lightpick--inlined"),
            r = n.getBoundingClientRect(),
            e = h
              ? u.el.parentNode.getBoundingClientRect()
              : u.el.getBoundingClientRect(),
            o = r.left - e.left + r.width / 2,
            s = r.top - e.top,
            f;
        ...
        e.multiDate &&
          e.midField &&
          (e.midField.addEventListener("change", u._onInputChange),
          e.midField.addEventListener("click", u._onInputClick),
          e.midField.addEventListener("focus", u._onInputFocus));
        e.secondField &&
          (e.secondField.addEventListener("change", u._onInputChange),
          e.secondField.addEventListener("click", u._onInputClick),
      ...
      (h.prototype = {
        config: function (t) {
          ...
          return (
            ...
            (i.calendar = [n().set("date", 1)]),
            i.numberOfMonths === 1 &&
              i.numberOfColumns > 1 &&
              (i.numberOfColumns = 1),
            (i.minDate =
              i.minDate && n(i.minDate).isValid() ? n(i.minDate) : null),
            (i.maxDate =
              i.maxDate && n(i.maxDate).isValid() ? n(i.maxDate) : null),
            i.lang === "auto" &&
            ...
            Object.prototype.toString.call(t.locale) === "[object Object]" &&
              (i.locale = $.extend({}, o.locale, t.locale)),
            !i.repick || i.secondField || i.multiDate || (i.repick = !1),
            i.inline && ((i.autoclose = !1), (i.hideOnBodyClick = !1)),
            (this._opts = $.extend({}, i)),
            this.syncFields(),
            this.setStartDate(this._opts.startDate, !0),
            this.setMidDate(this._opts.midDate, !0),
        ...
        syncFields: function () {
          var t;
          this._opts.multiDate
            ? this._opts.singleDate ||
              this._opts.midField ||
              this._opts.secondField
              ? (n(this._opts.field.value, this._opts.format).isValid() &&
                  (this._opts.startDate = n(
                    this._opts.field.value,
                    this._opts.format
                  )),
                this._opts.midfield &&
                  n(this._opts.midfield.value, this._opts.format).isValid() &&
                  (this._opts.midDate = n(
                ...
                this._opts.secondField &&
                  ...
                  (this._opts.endDate = n(
                    this._opts.secondField.value,
                    this._opts.format
                  )))
              : ((t = this._opts.field.value.split(this._opts.separator)),
                t.length === 2 &&
                  (n(t[0], this._opts.format).isValid() &&
                    (this._opts.startDate = n(t[0], this._opts.format)),
                  n(t[0], this._opts.format).isValid() &&
                    (this._opts.midDate = n(t[1], this._opts.format)),
                  this._opts.secondField &&
                    n(t[1], this._opts.format).isValid() &&
                    (this._opts.endDate = n(t[1], this._opts.format))))
            ...
            ? (n(this._opts.field.value, this._opts.format).isValid() &&
              ...
              this._opts.secondField &&
                n(this._opts.secondField.value, this._opts.format).isValid() &&
                (this._opts.endDate = n(
                  this._opts.secondField.value,
                  this._opts.format
                )))
        ...
        gotoMonth: function (n) {
          isNaN(n) ||
            (this._opts.calendar[0].set("month", n), r(this.el, this._opts));
        },
        gotoYear: function (n) {
          isNaN(n) ||
            (this._opts.calendar[0].set("year", n), r(this.el, this._opts));
        },
        prevMonth: function () {
          this._opts.calendar[0] = n(this._opts.calendar[0]).subtract(
            1,
            "month"
          );
          r(this.el, this._opts);
          ...
          if (!this.el.classList.contains("lightpick--inlined")) {
            if ((this.el.classList.remove("is-hidden"), this._opts.multiDate)) {
              if (this._opts.TargetDPId == "txtDepartDate_0")
                var i = this._opts.field.getBoundingClientRect(),
                  r = this.el.getBoundingClientRect(),
                  n = this._opts.orientation.split(" "),
                  u = 0,
                  f = 0;
              else if (this._opts.TargetDPId == "txtDepartDate_1")
                var i = this._opts.midField.getBoundingClientRect(),
                  r = this.el.getBoundingClientRect(),
                  n = this._opts.orientation.split(" "),
                  u = 0,
                  f = 0;
              else if (this._opts.TargetDPId == "txtDepartDate_2")
                var i = this._opts.secondField.getBoundingClientRect(),
                  r = this.el.getBoundingClientRect(),
                  n = this._opts.orientation.split(" "),
                  u = 0,
                  f = 0;
            ...
            n[0] != "auto" && /top|bottom/.test(n[0])
              ? ((u = i[n[0]] + window.pageYOffset),
                n[0] == "top" && (u -= r.height))
              : (u =
                  i.bottom + r.height > window.innerHeight &&
                  window.pageYOffset > r.height
                    ? i.top + window.pageYOffset - r.height
                    : i.bottom + window.pageYOffset);
            /left|right/.test(n[0]) ||
            (n[1] && n[1] != "auto" && /left|right/.test(n[1]))
              ? ((f = /left|right/.test(n[0])
                  ? i[n[0]] + window.pageXOffset
                  : i[n[1]] + window.pageXOffset),
                (n[0] == "right" || n[1] == "right") && (f -= r.width))
              : (f =
                  i.left + r.width > window.innerWidth
                    ? i.right + window.pageXOffset - r.width
                    : i.left + window.pageXOffset);
        ...
        setStartDate: function (t, i) {
          var r = n(t, n.ISO_8601),
            u = n(t, this._opts.format);
          ...
          this._opts.multiDate
            ? i ||
              typeof this._opts.onSelect != "function" ||
        ...
        setMidDate: function (t, i) {
          ...
          this._opts.midField
            ? (this._opts.startDate &&
              ...
              (this._opts.midField.value = this._opts.midDate.format(
                this._opts.format
              )))
            : (this._opts.field.value =
                this._opts.startDate.format(this._opts.format) +
                this._opts.separator +
                this._opts.midDate.format(this._opts.format));
          i ||
            typeof this._opts.onSelect != "function" ||
            this._opts.onSelect.call(
              this,
        ...
        setDate: function (n, t) {
          this._opts.singleDate &&
            (this.setStartDate(n, t), this.isShowing && i(this.el, this._opts));
        },
        setDateRange: function (n, t, r) {
          this._opts.singleDate ||
            (this.setStartDate(n, !0),
            this.setEndDate(t, !0),
        ...
        getStartDate: function () {
          return n(this._opts.startDate).isValid()
            ? this._opts.startDate
            : null;
        },
        getMidDate: function () {
        ...
        toString: function (t) {
          return this._opts.singleDate
            ? n(this._opts.startDate).isValid()
              ? this._opts.startDate.format(t)
              : ""
            : n(this._opts.startDate).isValid() &&
              n(this._opts.endDate).isValid()
            ? this._opts.startDate.format(t)
            : n(this._opts.startDate).isValid() &&
              !n(this._opts.endDate).isValid()
            ? this._opts.startDate.format(t)
        ...
        show: function (i) {
          if (this._opts.multiDate)
            this.isShowing ||
              ((this.isShowing = !0),
              this._opts.repick && (this._opts.repickTrigger = i),
              this.syncFields(),
              this._opts.secondField &&
              this._opts.secondField === i &&
              this._opts.endDate
                ? this.gotoDate(this._opts.midDate)
                : this._opts.secondField && this._opts.secondField === i
                ? this.gotoDate(this._opts.midDate)
                : this._opts.midField &&
                  this._opts.midField === i &&
                  this._opts.midDate
              ...
              typeof this._opts.onOpen == "function" &&
              ...
              this._opts.field === i &&
                (this._opts.startDate != null
                  ? $(".lightpick_selecteddate_From_Date").html(
                      n(this._opts.startDate).format("ddd DD MMM, YY")
                    )
                  : $(".lightpick_selecteddate_From_Date").html(
                      n().format("ddd DD MMM, YY")
                    )),
              this._opts.midField === i &&
                (this._opts.midDate != null
                  ? $(".lightpick_selecteddate_From_Date").html(
                      n(this._opts.midDate).format("ddd DD MMM, YY")
                    )
                  : this._opts.startDate != null
                  ? $(".lightpick_selecteddate_From_Date").html(
                      n(this._opts.startDate).format("ddd DD MMM, YY")
              ...
              this._opts.secondField === i &&
                (this._opts.endDate != null
                  ? $(".lightpick_selecteddate_From_Date").html(
                      n(this._opts.endDate).format("ddd DD MMM, YY")
                    )
                  : this._opts.midDate != null
                  ? $(".lightpick_selecteddate_From_Date").html(
                      n(this._opts.midDate).format("ddd DD MMM, YY")
            ...
            var u =
              ...
              r =
                '<span class="lightpick_selecteddate_To_Date_Header">Return</span>';
            (this._opts.TargetDPId == "tbCheckIn" ||
              this._opts.TargetDPId == "tbCheckOut") &&
              ((u =
                '<span class="lightpick_selecteddate_From_Date_Header">Check-in</span>'),
              (r =
                '<span class="lightpick_selecteddate_To_Date_Header">Check-out</span>'));
            ...
            this._opts.startDate != null
              ? $(".lightpick_selecteddate_From_Date").html(
                  u + n(this._opts.startDate).format("ddd DD MMM, YY")
                )
              : $(".lightpick_selecteddate_From_Date").html(
                  u + n().format("ddd DD MMM, YY")
                );
            this._opts.singleDate == !1 && this._opts.endDate != null
              ? $(".lightpick_selecteddate_To_Date").html(
                  r + n(this._opts.endDate).format("ddd DD MMM, YY")
                )
              : this._opts.singleDate == !1 && this._opts.endDate == null
              ? this._opts.startDate != null
                ? $(".lightpick_selecteddate_To_Date").html(
                    r + n(this._opts.startDate).format("ddd DD MMM, YY")
                  )
                : $(".lightpick_selecteddate_To_Date").html(
                    r + n().format("ddd DD MMM, YY")
                  )
              : ($(".lightpick_selecteddate_To_Date").html(""),
                $(".lightpick_selecteddate_To_Date").hide(),
                $(".lightpick_selecteddate_Separator").hide());
        ...
        hide: function () {
          this.isShowing &&
            ...
            (this.el.querySelector(".lightpick__tooltip").style.visibility =
              "hidden"),
            typeof this._opts.onClose == "function" &&
        ...
        destroy: function () {
          ...
          n.midField &&
            (n.midField.removeEventListener("change", this._onInputChange),
            n.midField.removeEventListener("click", this._onInputClick),
            n.midField.removeEventListener("focus", this._onInputFocus));
          n.secondField &&
            (n.secondField.removeEventListener("change", this._onInputChange),
            n.secondField.removeEventListener("click", this._onInputClick),
            n.secondField.removeEventListener("focus", this._onInputFocus));
...
$(window).scroll(function () {
  var n = document.getElementById("hdnSearchPageType"),
    t,
    i;
  n != null &&
    n.value == "MDF" &&
    ((t = $(".lightpick--2-columns").attr("data-top")),
    (i = $(".lightpick--2-columns").attr("data-left")),
    $(".lightpick--2-columns").css("top", parseInt(t)),
    $(".lightpick--2-columns").css("left", parseInt(i)),
...
$(document).ready(function () {
  $(".demo-label").click(function () {
    ...
    $(this)
      .closest(".m-loca")
      .find("span[class='spanCity']")
      .text("Airport/City Name");
    $(this)
      .closest(".m-loca")
      .find(".demo-label")
    ...
    $(this)
      .closest(".m-loca")
      .find("span[class='spanHotelCountry']")
      .text("Country Name");
  });
  $("#txtOriginCode").val().length
    ? $("#txtOriginCode").next().show()
    : $("#txtOriginCode").next().hide();
  $("#txtDestCode").val().length
    ? $("#txtDestCode").next().show()
    : $("#txtDestCode").next().hide();
  $("#txtOriginCode_0").val().length
    ? $("#txtOriginCode_0").next().show()
    : $("#txtOriginCode_0").next().hide();
  $("#txtDestCode_0").val().length
    ? $("#txtDestCode_0").next().show()
    : $("#txtDestCode_0").next().hide();
  $("#txtOriginCode_1").val().length
    ? $("#txtOriginCode_1").next().show()
    : $("#txtOriginCode_1").next().hide();
  $("#txtDestCode_1").val().length
    ? $("#txtDestCode_1").next().show()
    : $("#txtDestCode_1").next().hide();
  $("#txtOriginCode_2").val().length
    ? $("#txtOriginCode_2").next().show()
    : $("#txtOriginCode_2").next().hide();
  $("#txtDestCode_2").val().length
    ? $("#txtDestCode_2").next().show()
    : $("#txtDestCode_2").next().hide();
  $(".iexchangeIcon").click(function () {
    var n = document.getElementById("txtOriginCode").value,
      t = document.getElementById("hdnOriginCode").value,
      i = document.getElementById("spanOriginCityName").innerHTML,
      r = document.getElementById("txtDestCode").value,
      u = document.getElementById("hdnDestinationCode").value,
      f = document.getElementById("spanDestCityName").innerHTML;
  ...
  $("#txtPreferredAirlines")
    .autocomplete({
      ...
      blur: function (n, t) {
        return (
          $("#txtPreferredAirlines").val(t.item.Name),
          $("#hdnPreferredAirline").val(t.item.Code),
          !1
        );
      },
      select: function (n, t) {
  ...
  $("#BtnSearchFare_RTOW").click(function (n) {
    ...
    return (
      ...
      t &&
        $("#hdnOriginCode").val() != "" &&
        $("#hdnDestinationCode").val() != "" &&
        ($("#hdnOriginCode").val() == $("#hdnDestinationCode").val()
          ? ((t = !1),
      ...
      t &&
        $("#txtDepartDate").val() == "" &&
        ((t = !1), $("#spnDepDateErrMsg").show(), $("#txtDepartDate").focus()),
      $("#hdnTripTypeCode").val() === "1" &&
        t &&
        $("#txtReturnDate").val() == "" &&
        ((t = !1), $("#spnRetDateErrMsg").show(), $("#txtReturnDate").focus()),
      t &&
        ($("#BtnSearchFare_RTOW")
          .attr("disabled", "disabled")
          .text("Searching..."),
        (i = $("#formFlightSearchEngine").serialize()),
        $.post("/Search/AirSearch/", i, function (n) {
          n == "Success"
            ? window.parent
              ? (window.parent.location =
                  "/air/listing/" + $("#hdnFlightUniqueCode").val())
              : (window.location =
                  "/air/listing/" + $("#hdnFlightUniqueCode").val())
            : window.parent
    ...
    if (
      ($("#txtOriginCode_0").val() == ""
        ...
        : $("#hdnMC_Sec_2").val() == "1" &&
          ...
          $("#txtDestCode_2").focus()),
      t &&
        ($("#hdnOriginCode_0").val() == $("#hdnDestinationCode_0").val()
          ? ((t = !1),
            $("#spnDestErrMsg_0").text(
              "Origin and destination can not be same"
            ),
            $("#spnDestErrMsg_0").show(),
            $("#txtDestCode_0").focus())
          : $("#hdnOriginCode_1").val() == $("#hdnDestinationCode_1").val()
          ? ((t = !1),
            $("#spnDestErrMsg_1").text(
              "Origin and destination can not be same"
            ),
            $("#spnDestErrMsg_1").show(),
            $("#txtDestCode_1").focus())
          : $("#hdnMC_Sec_2").val() == "1" &&
            $("#hdnOriginCode_2").val() == $("#hdnDestinationCode_2").val()
          ? ((t = !1),
            $("#spnDestErrMsg_2").text(
              "Origin and destination can not be same"
            ),
            $("#spnDestErrMsg_2").show(),
            $("#txtDestCode_2").focus())
      ...
      var s = $("#formFlightSearchEngine").serialize(),
        i = "0",
        r = "MultiAirSearch";
      i = checkMulticityGetRT();
      i == "1" &&
        ((r = "AirSearch"),
        (u = $("#hdnOriginCode_0").val()),
        $("#hdnOriginCode").val(u),
        (f = $("#hdnDestinationCode_0").val()),
        $("#hdnDestinationCode").val(f),
        (e = $("#txtDepartDate_0").val()),
        $("#txtDepartDate").val(e),
        (o = $("#txtDepartDate_1").val()),
        $("#txtReturnDate").val(o),
        $("#hdnTripTypeCode").val("1"));
  ...
  $("select#LstCabinClass").change(function () {
    var n = $("#LstCabinClass option:selected").text(),
      t = $("#txtAdultPassenger").val(),
      i = $("#txtChildPassenger").val(),
      r = $("#txtInfantSeatPassenger").val(),
      u = $("#txtInfantPassenger").val(),
      f = parseInt(t) + parseInt(i) + parseInt(r) + parseInt(u);
...
$(document).ready(function () {
  $("#txtOriginCode")
    .autocomplete({
      ...
      source: function (n, t) {
        ...
        $.ajax({
          ...
          success: function (n) {
            if (
              ((AutoSuggest_Counter = 0), n.toString().indexOf("Invalid") == -1)
            ) {
              var i = JSON.parse(n);
              t(i);
            }
      ...
      blur: function (n, t) {
        return (
          $("#txtOriginCode").val(t.item.AC),
          $("#spanOriginCityName").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnOriginCode").val(t.item.AC),
          $("#txtOriginCode_0").val(t.item.AC),
          $("#spanOriginCityName_0").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnOriginCode_0").val(t.item.AC),
          !1
        );
      },
      select: function (n, t) {
        return (
          ...
          $("#spanOriginCityName_0").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnOriginCode_0").val(t.item.AC),
          n.key != "Tab" && $("#txtDestCode").focus(),
          !1
        );
      },
      close: function () {
        if (
          $("#hdnOriginCode").val().trim() == "" &&
          AutoSuggest_Target == "txtOriginCode" &&
          $("#txtOriginCode").val().length > 2 &&
          AutoSuggest_AC != ""
        )
          return (
            $("#txtOriginCode").val(AutoSuggest_AC),
            $("#spanOriginCityName").text(
              AutoSuggest_CIN + ", " + AutoSuggest_CON
            ),
            $("#hdnOriginCode").val(AutoSuggest_AC),
            $("#txtOriginCode_0").val(AutoSuggest_AC),
            $("#spanOriginCityName_0").text(
              AutoSuggest_CIN + ", " + AutoSuggest_CON
            ),
    ...
    return (
      AutoSuggest_Counter == 0 &&
        ...
        (AutoSuggest_Target = "txtOriginCode"),
        (AutoSuggest_AC = t.AC),
        (AutoSuggest_CIN = t.CIN),
        (AutoSuggest_CON = t.CON)),
      (AutoSuggest_Counter = 1),
      (i = ""),
      (i =
        t.COA == null || t.COA == undefined || t.COA == ""
          ? t.P == "1" && t.P2 == "1"
            ? "<li>" +
              t.CIN +
              ", " +
      ...
      (u = r.replace(
        ...
        "<span class='highlight-auto-list'>$&</span>"
      )),
      $(
        "<li class='airList " +
          (t.P == "1" || t.P == "100"
  ...
  $("#txtDestCode")
    .autocomplete({
      ...
      blur: function (n, t) {
        return (
          $("#txtDestCode").val(t.item.AC),
          $("#spanDestCityName").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnDestinationCode").val(t.item.AC),
          $("#txtDestCode_0").val(t.item.AC),
          $("#spanDestCityName_0").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnDestinationCode_0").val(t.item.AC),
          !1
        );
      },
      select: function (n, t) {
    ...
    .autocomplete({
      ...
      select: function (n, t) {
        return (
          ...
          $("#spanOriginCityName").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnOriginCode").val(t.item.AC),
          n.key != "Tab" && $("#txtDestCode_0").focus(),
          !1
        );
      },
      close: function () {
        if (
          $("#hdnOriginCode_0").val().trim() == "" &&
          AutoSuggest_Target == "txtOriginCode_0" &&
          $("#txtOriginCode_0").val().length > 2 &&
          AutoSuggest_AC != ""
        )
          return (
            $("#txtOriginCode_0").val(AutoSuggest_AC),
    ...
    .autocomplete({
      ...
      blur: function (n, t) {
        return (
          ...
          $("#spanDestCityName").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnDestinationCode").val(t.item.AC),
          $("#txtOriginCode_1").val(t.item.AC),
          $("#spanOriginCityName_1").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnOriginCode_1").val(t.item.AC),
          !1
        );
      },
      select: function (n, t) {
      ...
      close: function () {
        if (
          $("#hdnDestinationCode_0").val().trim() == "" &&
          AutoSuggest_Target == "txtDestCode_0" &&
          $("#txtDestCode_0").val().length > 2 &&
          AutoSuggest_AC != ""
        )
          return (
            $("#txtDestCode_0").val(AutoSuggest_AC),
    ...
    .autocomplete({
      ...
      select: function (n, t) {
        return (
          ...
          $("#spanOriginCityName_1").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnOriginCode_1").val(t.item.AC),
          n.key != "Tab" && $("#txtDestCode_1").focus(),
          !1
        );
      },
      close: function () {
        if (
          $("#hdnOriginCode_1").val().trim() == "" &&
          AutoSuggest_Target == "txtOriginCode_1" &&
          $("#txtOriginCode_1").val().length > 2 &&
          AutoSuggest_AC != ""
        )
          return (
            $("#txtOriginCode_1").val(AutoSuggest_AC),
            $("#spanOriginCityName_1").text(
              AutoSuggest_CIN + ", " + AutoSuggest_CON
            ),
  ...
  $("#txtDestCode_1")
    .autocomplete({
      ...
      blur: function (n, t) {
        return (
          $("#txtDestCode_1").val(t.item.AC),
          $("#spanDestCityName_1").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnDestinationCode_1").val(t.item.AC),
          $("#hdnMC_Sec_2").val() == "1" &&
            ($("#txtOriginCode_2").val(t.item.AC),
            $("#spanOriginCityName_2").text(t.item.CIN + ", " + t.item.CON),
            $("#hdnOriginCode_2").val(t.item.AC)),
          !1
        );
      },
      select: function (n, t) {
    ...
    .autocomplete({
      ...
      select: function (n, t) {
        return (
          ...
          $("#spanOriginCityName_2").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnOriginCode_2").val(t.item.AC),
          n.key != "Tab" && $("#txtDestCode_2").focus(),
          !1
        );
      },
      close: function () {
        if (
          $("#hdnOriginCode_2").val().trim() == "" &&
          AutoSuggest_Target == "txtOriginCode_2" &&
          $("#txtOriginCode_2").val().length > 2 &&
          AutoSuggest_AC != ""
        )
          return (
            $("#txtOriginCode_2").val(AutoSuggest_AC),
  ...
  $("#txtDestCode_2")
    .autocomplete({
      ...
      blur: function (n, t) {
        return (
          $("#txtDestCode_2").val(t.item.AC),
          $("#spanDestCityName_2").text(t.item.CIN + ", " + t.item.CON),
          $("#hdnDestinationCode_2").val(t.item.AC),
          !1
        );
      },
      select: function (n, t) {
      ...
      close: function () {
        if (
          $("#hdnDestinationCode_2").val().trim() == "" &&
          AutoSuggest_Target == "txtDestCode_2" &&
          $("#txtDestCode_2").val().length > 2 &&
          AutoSuggest_AC != ""
        )
          return (
            $("#txtDestCode_2").val(AutoSuggest_AC),
            $("#spanDestCityName_2").text(
              AutoSuggest_CIN + ", " + AutoSuggest_CON
            ),
